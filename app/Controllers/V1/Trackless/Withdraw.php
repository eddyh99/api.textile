...
/*----------------------------------------------------------
    Modul Name  : Modul TC Bank Withdraw
    Desc        : Modul ini di gunakan untuk aktifitas withdraw di sisi admin bank
                  Withdraw di sisi TC Bank hanya dikenakan Wise Fee
    Sub fungsi  : 
        - WDTrackless_Summary   : berfungsi mendapatkan informasi Fee Transfer
        - getFee                : berfungsi mendapatkan Wise Fee
        - WDTrackless_Transfer  : berfungsi memproses transfer wise
...
class Withdraw extends BaseController
{
    ...
    {   
        /*----------------------------------------------------------
            trackless\wallet    => untuk cek balance TC Bank dan simpan withdraw
            trackless\cost      => untuk ambil wise fee
        ------------------------------------------------------------*/
	...
	public function WDTrackless_Summary(){
        ...
        $balance    = number_format($this->wallet->balance_ByCurrency($data->currency),2,'.','');
        ...
        $deduct     = number_format($amount + $wise_cost,2,'.','');
        if ($balance < $amount) {
    	    $response=[
    	            "code"     => "5055",
    	            "error"    => "20",
    ...
    public function WDTrackless_Transfer(){
